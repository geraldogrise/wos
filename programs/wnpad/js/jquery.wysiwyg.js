...
html: '<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd"><html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" style="margin:0"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"></head><body style="margin:0;">INITIAL_CONTENT</body></html>',
		...
		this.insertText = function (szHTML) {
			...
			if ($.browser.msie) {
				...
				this.ui.focus();
				this.editorDoc.execCommand("insertText", false, szHTML);
			} else {
				...
				if ($.browser.mozilla) { // @link https://github.com/akzhan/jwysiwyg/issues/50
					...
					if (!this.editorDoc.execCommand("insertText", false, szHTML)) {
						this.editor.focus();
		...
		this.removeText = function () {
			...
			if ($.browser.msie) {
				...
				this.ui.focus();
				this.editorDoc.execCommand("delete");
			} else {
	...
	$.wysiwyg = {
		...
		removeText: function (object) {
			return object.each(function () {
				...
				var sele = oWysiwyg.getRangeText();
				oWysiwyg.removeText();
