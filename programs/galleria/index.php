...
<?php
      require_once('includePath.php');
	    $caminhoGalleria= $software."programs/galleria/";
...
?>
	...
	<div id="galleria_0" tabindex="-1" style="display:none;z-index:10;" class="abs window program galleria">
      <div class="abs window_inner">
        <div class="window_top">
          <span class="float_left">
            <img src="images/programs/galleria.png" style="width:16px;height:16px" />
            Galleria
          </span>
          <span class="float_right">
            <a href="#" class="window_min"></a>
            <a href="#" class="window_resize" onclick="resizeWindowGalleria(this,'resizeGalleria(this)');"></a>
