...
(function($)
{
    ...
    $.fn.blackCalculator = function(options) {
        ...
        var form = '<form method="post" action="#" id="blackCalculatorForm"><fieldset>';
		...
		// line 1
		var lines = '<a href="#" title="' + settings.language.backspace
		+ '" style="width:58px; margin:0;" rel="<">&lArr;</a>';
		
		if (settings.type == 'advanced') {
			lines += '<a href="#" title="' + settings.language.clear + '" rel="c">C</a>';
			lines += '<a href="#" title="(" rel="(">(</a>';
			lines += '<a href="#" title=")" rel=")">)</a>';
		} else {
			lines += '<a href="#" title="' + settings.language.clear + '" rel="c" style="width:101px;">' +
			settings.language.clear + '</a>';
		}
		
		// line 2
		lines += '<a href="#" title="7" style="margin:0;" rel="7">7</a>';
        lines += '<a href="#" title="8" rel="8">8</a>';
        lines += '<a href="#" title="9" rel="9">9</a>';
		
		if (settings.type == 'advanced') {
			lines += '<a href="#" title="/" rel="/">/</a>';
			lines += '<a href="#" title="%" rel="%">%</a>';
		} else {
			lines += '<a href="#" title="/" rel="/" style="width:57px;">/</a>';
		}
		
		// line 3
		lines += '<a href="#" title="4" style="margin:0;" rel="4">4</a>';
        lines += '<a href="#" title="5" rel="5">5</a>';
        lines += '<a href="#" title="6" rel="6">6</a>';
		
		if (settings.type == 'advanced') {
			lines += '<a href="#" title="*" rel="*">*</a>';
			lines += '<a href="#" title="yx" rel="yx">y<sup>x</sup></a>';
		} else {
			lines += '<a href="#" title="*" rel="*" style="width:57px;">*</a>';
		}
		
		// line 4
		lines += '<a href="#" title="1" style="margin:0;" rel="1">1</a>';
        lines += '<a href="#" title="2" rel="2">2</a>';
        lines += '<a href="#" title="3" rel="3">3</a>';
		...
		// line 5
		if (settings.type == 'advanced') {
			lines += '<a href="#" title="0" style="width:58px; margin:0;" rel="0">0</a>';
		} else {
			lines += '<a href="#" title="0" rel="0" style="margin:0;">0</a>';
		}
		...
		if (settings.type == 'advanced') {
			lines += '<a href="#" title="=" rel="=" style="height:40px; padding-top:35px;' +
