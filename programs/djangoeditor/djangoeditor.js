 ...
 */
var id_program = "";
var contDjangoEditor = 0;




function callWindowDjangoEditor(id,pathDjango){
...
function resizeDjangoEditor(button){
...
function resizeWindowDjangoEditor(button,callBackfunction){
    id = $(button).closest('.program').attr('id');
...
function openDjangoPath(id_DjangoEditor,pathDjango){
  ...
  $.ajax({
            ...
            data:   'path='+pathDjango+"&action=readFile",
            ...
            dataType  : 'JSON',
                ...
                success : function(retorno){
				      ...
				      if(retorno.is_erro == "true"){
						  ...
						  editor =  $('#'+id_DjangoEditor).find('.CodeMirror')[0].CodeMirror;
...
function openDjango_O(button,id_program){
...
function saveDjango(button,id_program){
