        ...
        gips: function (options) {
            ...
            return this.each(function () {
                ...
                if (!settings.autoHide)
                    closebtn = '<img src="' + settings.imagePath + '" class="gips-close" alt="close" onclick="closeAllGipProgram(this)" />';
                var toolTipContainer = $('<div class="gips-container"><div class="gips-body ' + settings.theme + ' '+ $(this).attr('program')+'_gips">' + settings.text + '' +
                                        '' + closebtn + '</div><div class="gips-icon gips-icon-' + iconDirection + ' ' + settings.theme + '"></div></div>');

                control.closest('.abs').before(toolTipContainer);
